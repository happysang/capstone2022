...
class MobileViTBlock(nn.Module):
    def __init__(self, dim, depth, channel, kernel_size, patch_size, mlp_dim, dropout=0.3):
        super().__init__()
...
class MobileViT(nn.Module):
    def __init__(self, image_size, dims, channels, num_classes, expansion=4, kernel_size=3, patch_size=(2, 2)):
        ...
        #edit hojun
        # self.multi_head_layer = [nn.Sequential(nn.Linear(in_features=channels[-1], out_features=num_out_feature,bias=False)) \
    ...
    def forward(self, x):
        ...
        # print(x0.size())
        # sys.exit()
        return x0 #F.log_softmax(x0,dim=1)
